...
<?php
        ...
        $query = mysqli_query($conn, "UPDATE Animals SET `Deceased` = 1 WHERE Animal_ID = '$animal'");
...
echo('<br><br><div style="text-align:center;padding-top: 10%; color:red;font-size:20px;">Animal_ID: '.$animal.'</div><br>');
